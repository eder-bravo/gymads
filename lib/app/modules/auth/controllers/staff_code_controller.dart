...
class StaffCodeController extends GetxController {
  ...
  Future<bool> entrar() async {
    ...
    try {
      ...
      //
      //    Los recorridos guiados no se tocan aquí: los que ya vio el
      //    empleado van en su acceso, en la base, y sobreviven a un código
      //    nuevo. Antes se marcaban todos como pendientes en cada canje y un
      //    código regenerado le volvía a mostrar todo.
