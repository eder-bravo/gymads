...
class AbonoPricesRepository {
  ...
  static const _columns = 'price_day, price_week, price_month, price_year';
  ...
  Future<AbonoPricesModel> getPrices() async {
    try {
      ...
      AppLogger.error('AbonoPricesRepository', 'Error al obtener precios de abono', e);
  ...
  Future<bool> savePrices(AbonoPricesModel prices) async {
    try {
      ...
      AppLogger.error('AbonoPricesRepository', 'Error al guardar precios de abono', e);
      return false;
    }
  }
}
